...
if a.status_code != 0:
	# data = {}
	with open('/home/tanmay/Documents/Dikastis/minor/dikastis/log.json') as data_file:
		data = json.load(data_file)
	data[str(sys.argv[1])] = response_msg('OK', verdict['CE'])
	f = open('/home/tanmay/Documents/Dikastis/minor/dikastis/log.json', 'w')
	...
	f = open("/home/tanmay/Documents/Dikastis/minor/dikastis/problems/" + str(sys.argv[2]) + ".in", 'r')
	# f.write(str(a.output))
	a = soldier.run("sudo -H -u judge bash -c 'timeout 1s /home/judge/"+str(sys.argv[1])+"'", stdin=str(f.read()))
	f.close()
	f = open("/home/tanmay/Documents/Dikastis/minor/dikastis/submissions/"+str(sys.argv[1]) + '.out', 'w')
	f.write(str(a.output))
	f.close()
	# time limit check
	...
	# wa check
		...
		a = soldier.run("diff /home/tanmay/Documents/Dikastis/minor/dikastis/problems/" + str(sys.argv[2]) + ".out " + "/home/tanmay/Documents/Dikastis/minor/dikastis/submissions/" + str(sys.argv[1]) + ".out")
		# print a.output
		if a.output:
			# data = {}
			with open('/home/tanmay/Documents/Dikastis/minor/dikastis/log.json') as data_file:
